...
- 🛠 **AI/ML Stack:** Pytorch, Scikit-Learn, Langgraph, Langchain.
- ☁️ **Cloud Certifications:** Huawei Certified Cloud Developer Associate (Tech Essentials & AI).
- ⚡ **Fun fact:** I built my own UNIX command-line interpreter and `printf` function from scratch in C.
